...
namespace wabby::render::vulkan
{
  ...
  vk_queue_cache::vk_queue_cache( const vk_hardware & hardware, const vk::raii::SurfaceKHR & surface ) : hardware_( hardware ), surface_( surface ) {}
